package net.raphimc.immediatelyfast.gui.components;

import net.raphimc.immediatelyfast.Argon;
import net.raphimc.immediatelyfast.gui.Window;
import net.raphimc.immediatelyfast.gui.components.settings.*;
